...
这两张图就是工具每天的全部目标。它不会做别的事：不发帖、不回复、不点赞、不写日记（除非你明确打开随机心情，见 [自动签到](#签到)）。
...
4. **自动签到。** 打开签到页，点「没心情」，点「提交签到」。细节见 [自动签到](#签到)。
...
2. **选「没心情」。** 签到页要求选一个心情。选「没心情」的好处是：网站不会要求你写「今日说说」，你的主页不会多出任何一条记录。
...
如果你觉得每天一格「没心情」太像机器，可以在账号配置里打开随机心情（怎么写见使用说明）。打开后：

- 从网站提供的 10 种心情里按权重抽一个。日常心情多、强烈情绪少，看起来像真人。
- 昨天的心情有四分之一的概率延续到今天，所以会出现连着几天「疲惫」这种自然的连续。
- 从随仓库分发的 321 句中性短句里抽一句填进「说说」，最近 30 天用过的句子不重复。

> [!IMPORTANT]
> 打开后，每天会以你的名义在主页发一句话。这是你的选择，工具不替你决定。不打开，行为和以前完全一样。
